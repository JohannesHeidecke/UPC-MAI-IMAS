...
\HRule \\[0.4cm]
{ \huge \bfseries Analysis of Cooperation Mechanisms}\\[0.4cm] % Title of your document
\large{Deliverable 2}
\HRule \\[1.5cm]
...
{\large December 2016}\\[3cm] % Date, change the \today to a set date if you want to be precise

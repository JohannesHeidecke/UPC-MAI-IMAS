...
\textsc{\large 	Introduction to Multi-Agent Systems}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries Garbage Collection MAS}\\[0.4cm] % Title of your document
\large{Critical Review}
\HRule \\[1.5cm]
...
\Large \emph{by:}\\
Sebastian \textsc{Berns}\\ % Your name
Helen \textsc{Byrne}\\ % Your name
Johannes \textsc{Heidecke}\\ % Your name
Sara  \textsc{Hoeksma Palazuelos}\\ % Your name
Maritza \textsc{Prieto}\\ [3cm]% Your name
...
{\large February 2017}\\[3cm] % Date, change the \today to a set date if you want to be precise
